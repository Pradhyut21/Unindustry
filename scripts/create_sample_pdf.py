...
def create_datasheet_pdf(output_path: Path) -> None:
    ...
    page.insert_text((30, 130), "3-Pole Contactor for Motor Control Applications",
    ...
    # ── Certifications ─────────────────────────────────────────────────────────
    page.insert_text((30, y + 20), "CERTIFICATIONS & STANDARDS", fontsize=13,
                     color=BLUE, fontname="helv")
    page.draw_line((30, y + 27), (565, y + 27), color=BLUE, width=0.8)
    page.insert_text((35, y + 45),
                     "CE  |  UL Listed  |  CSA  |  RoHS Compliant",
                     fontsize=11, color=DARK)
    page.insert_text((35, y + 62),
                     "IEC 60947-4-1  |  EN 60947-4-1  |  VDE 0660",
                     fontsize=11, color=DARK)

    # ── Ordering info ──────────────────────────────────────────────────────────
    page.insert_text((30, y + 90), "ORDERING INFORMATION", fontsize=13,
                     color=BLUE, fontname="helv")
    ...
    page.draw_rect(plate_rect, color=(0.85, 0.85, 0.85), fill=(0.95, 0.95, 0.95),
                   width=1.0)
